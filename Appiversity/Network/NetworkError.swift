...
enum NetworkError : Error {
    ...
    case wrongPassword
    case networkError
    case someUnknownFirebaseCode
    case unknownError
    
    // error related signing out
    case noUserWasSignedInOrFound
    case couldNotSignUserOut
}
extension NetworkError : LocalizedError{
    var errorDescription: String?{
        switch self {
        case .emptyEmailTextField: return NSLocalizedString("Empty email Text Field", comment: "No email was typed")
        case .emptyPasswordTextField: return NSLocalizedString("Empty password Field", comment: "No password was typed")
        case .wrongPassword: return NSLocalizedString("Wrong password", comment: ".wrongPassword")
        case .networkError: return NSLocalizedString("There was a network error", comment: ".networkError")
        case .someUnknownFirebaseCode: return NSLocalizedString("Some Unknown firebase code happned", comment: ".someUnknownFirebaseCode")
        case .unknownError: return NSLocalizedString("Unknown error", comment: "Unknow error ")
            
            // error related signing out
        case .noUserWasSignedInOrFound: return NSLocalizedString("No user was signed in or found!", comment: ".noUserWasSignedInOrFound")
        case .couldNotSignUserOut: return NSLocalizedString("Could not sign out please try again.", comment: ".couldNotSignUserOut")
...
//        switch errorCode.code{
//            case .accountExistsWithDifferentCredential: print(1234)
//            case .invalidCustomToken:
//                <#code#>
//            case .customTokenMismatch:
//                <#code#>
